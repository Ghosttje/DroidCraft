...
import be.perrybmwghosttje.droidcraft.client.renderer.models.ModelWirelessCharger;
 ...
 */
public class ItemRendererWirlessCharger implements IItemRenderer {

    private ModelWirelessCharger modelDynamo = new ModelWirelessCharger();
    ...
    private void render(float x, float y, float z)
    {
        ...
        // Bind texture
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(TextureReferences.Models.WIRLESSCHARGER);
